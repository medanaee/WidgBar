  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-active:bg-background data-active:text-foreground dark:data-active:border-transparent dark:data-active:bg-zinc-950/50 dark:data-active:text-foreground",
