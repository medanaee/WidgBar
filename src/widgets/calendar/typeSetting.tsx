...
export default function CalendarTypeSetting() {
    ...
    const widgetConfig = registry['calendar'];
                ...
                <div className="flex gap-2 items-center">
                    <div className="flex flex-col gap-1 items-center">
                        ...
                        <NumberInput 
                            ...
                            onChange={(val) => updateWidgetType('calendar', { default_width: val })}
                        />
                    </div>
                    ...
                    <div className="flex flex-col gap-1 items-center">
                        ...
                        <NumberInput 
                            min={150} max={800} step={10}
                            value={widgetConfig.default_height || 220}
                            onChange={(val) => updateWidgetType('calendar', { default_height: val })}
                        />
                    </div>
                </div>
            </div>
