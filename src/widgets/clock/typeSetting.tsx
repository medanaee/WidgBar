...
export default function ClockTypeSetting() {
    ...
    const widgetConfig = registry['clock'];
        ...
        <div className="space-y-3 pt-2">
            <div className="flex items-center justify-between p-3.5 rounded-xl bg-white/50 dark:bg-zinc-900/10 border border-zinc-500/20 dark:border-zinc-500/20 shadow-sm transition-all hover:bg-white/80 dark:hover:bg-zinc-900/50">
                <div className="flex-grow min-w-0 pr-3">
                    ...
                    <p className="text-xs text-zinc-500 dark:text-zinc-400">Set the default width and height for all Clock widgets and Popups</p>
                </div>
                <div className="flex gap-2 items-center">
                    <div className="flex flex-col gap-1 items-center">
                        ...
                        <NumberInput 
                            ...
                            onChange={(val) => updateWidgetType('clock', { default_width: val })}
                        />
                    </div>
                    ...
                    <div className="flex flex-col gap-1 items-center">
                        ...
                        <NumberInput 
                            ...
                            onChange={(val) => updateWidgetType('clock', { default_height: val })}
                        />
                    </div>
                </div>
            </div>
