...
export function FigmaIcon({ className = "w-5 h-5", size }: { className?: string; size?: number }) {
  const style = size ? { width: `${size}px`, height: `${size}px` } : undefined;
  return (
    <svg className={cn("shrink-0", className)} style={style} viewBox="0 0 38 57" fill="none" xmlns="http://www.w3.org/2000/svg">
